...
var Runewords = {
	makeMultiple: false, //Keep multiple runesets and bases for the same runeword?
	waitForBase: false, //Start picking runes for rws before having a base?
	...
	buildLists: function () {
		...
		for (i = 0; i < Config.Runewords.length; i += 1) {
			...
			//if (!this.waitForBase || this.getBase(Config.Runewords[i][0], Config.Runewords[i][1], (Config.Runewords[i][2]||0))) {
			if (!(Config.Runewords[i][3] || this.waitForBase) || this.getBase(Config.Runewords[i][0], Config.Runewords[i][1], (Config.Runewords[i][2]||0))) {
RuneLoop:
