function LoadConfig() {
	...
	Config.GambleGoldStop 	= (me.diff === 2 && me.getQuest(22, 0)) ? 300000 : 500000;
	...
	// Gold
	Config.StashGold 		= (me.diff === 2 && me.getQuest(22, 0)) ? 30000 : 100; 		// Minimum amount of gold to stash.
	Config.LowGold 			= (me.diff === 2 && me.getQuest(22, 0)) ? 300000 : 800000; 	// Start selling crap items if lower.
