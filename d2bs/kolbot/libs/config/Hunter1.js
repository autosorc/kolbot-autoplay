...
function LoadConfig() {
	...
	Scripts.Hunter = true; // Hunter ingame script
	...
	*/
	...
	// *** special scripts ***
	Scripts.Hunter = true; //Kill Diablo Clone by using Arcane Sanctuary waypoint. Diablo needs to walk the Earth in the game.
	...
	Config.UseRejuvHP = 25;  // Drink a rejuvenation potion if life is under designated percent.
	...
	Config.MaxGameTime = 450; // Maximum game time in seconds. Quit game when limit is reached.
