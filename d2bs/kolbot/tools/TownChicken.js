...
function main() {
	...
	while (true) {
		if (!me.inTown && (townCheck ||
			(Config.TownHP !== 0 && Config.TownHP > 0 && me.hp < Math.floor(me.hpmax * Config.TownHP / 100)) ||
			(Config.TownMP !== 0 && Config.TownMP > 0 && me.mp < Math.floor(me.mpmax * Config.TownMP / 100)))) {
			this.togglePause();
